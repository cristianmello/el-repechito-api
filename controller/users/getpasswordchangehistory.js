...
const getPasswordChangeHistory = async (req, res) => {
    try {
        ...
        const logs = await PasswordChangeLog.findAndCountAll({
            where,
            include: [
                {
                    model: User,
        ...
        console.error('Error al obtener historial de cambio de contraseña:', error);
        return res.status(500).json({ message: 'Error del servidor' });
    }
};

module.exports = getPasswordChangeHistory;
